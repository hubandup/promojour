      ...
      <Card className="border-primary/20 bg-primary/5">
        <CardContent className="pt-6">
          <div className="flex items-start gap-4">
            ...
            <div>
              <h3 className="font-semibold mb-1">Qu'est-ce qu'une campagne ?</h3>
              ...
              <div className="space-y-4">
                <div className="grid grid-cols-2 gap-4">
                  <div className="p-4 bg-muted/50 rounded-lg">
                    <div className="text-2xl font-bold text-primary">{campaign.promosPerDay}</div>
                    <div className="text-sm text-muted-foreground mt-1">Promos / jour</div>
                  </div>
                  <div className="p-4 bg-muted/50 rounded-lg">
                    <div className="text-2xl font-bold text-primary">{campaign.totalPromos}</div>
                    <div className="text-sm text-muted-foreground mt-1">Total promotions</div>
                  </div>
                </div>
